...
core_init_state(ee_u32 size, ee_s16 seed, ee_u8 *p)
{
    ...
    floatpat[0] = (ee_u8 *)"35.54400";
    floatpat[1] = (ee_u8 *)".1234500";
    floatpat[2] = (ee_u8 *)"-110.700";
    floatpat[3] = (ee_u8 *)"+0.64400";

    scipat[0] = (ee_u8 *)"5.500e+3";
    scipat[1] = (ee_u8 *)"-.123e-2";
    scipat[2] = (ee_u8 *)"-87e+832";
    scipat[3] = (ee_u8 *)"+0.6e-12";

    errpat[0] = (ee_u8 *)"T0.3e-1F";
    errpat[1] = (ee_u8 *)"-T.T++Tq";
    errpat[2] = (ee_u8 *)"1T3.4e4z";
    errpat[3] = (ee_u8 *)"34.0e-T^";
